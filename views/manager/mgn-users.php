    ...
    <div class="panel panel-default buffer">
      <div class="panel-body">
        ...
        <table class="table">
          ...
          <tr>
            <td>
              <?php echo htmlspecialchars($user['projectName']); ?>
            </td>
            <td>
              <?php echo htmlspecialchars($user['description']); ?>
            </td>
            <td>
              <?php echo htmlspecialchars($user['sampleSite_Link']); ?>
            </td>
            <td>
              <form action="../controllers/managerController.php" method="post">
                <input type='hidden' name='project_code' value=<?php echo htmlspecialchars($user['id']); ?>>
